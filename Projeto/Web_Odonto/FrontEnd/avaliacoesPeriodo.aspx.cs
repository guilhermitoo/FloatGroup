...
namespace FrontEnd
{
    public partial class avaliacoesPeriodo : System.Web.UI.Page
    {
        ...
        {
            AvaliacaoModel aModel = new AvaliacaoModel();
            ...
            if ((txtDatIni.Value != "") && (txtDatFin.Value != ""))
            {
                ...
                gvRelatorio.DataSource = aModel.ListarPorPeriodo(datIni, datFin);
