<%@ Page Title="" Language="C#" MasterPageFile="~/Web_Odonto.Master" AutoEventWireup="true" CodeBehind="listaPacientes.aspx.cs" Inherits="FrontEnd.listaPacientes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="p" runat="server">
    ...
    <br />
    <br />
    <asp:Repeater ID="rListaPacientes" runat="server">     
        <HeaderTemplate>
