...
<asp:Content ID="Content2" ContentPlaceHolderID="p" runat="server">
    ...
    <br />        
    <div class="col-md-5">
        <asp:TextBox ID="txtDescricaoProcedimento" runat="server" CssClass="form-control" placeholder="<%$ resources: praceholder %>" ToolTip="Descrição do Procedimento" meta:resourcekey="txtDescricaoProcedimentoResource1" ></asp:TextBox>    
    </div>
    <div class="col-md-4">
