<%@ Page Title="" Language="C#" MasterPageFile="~/Web_Odonto.Master" AutoEventWireup="true" CodeBehind="tratamentosPeriodo.aspx.cs" Inherits="FrontEnd.tratamentosPeriodo" meta:resourcekey="PageResource1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="p" runat="server">
    <asp:Panel runat="server" ID="pnlRelatorio" meta:resourcekey="pnlRelatorioResource1">
        <div class="panel-heading">
            <h2><label id="lbTitulo"><asp:Literal ID="lt00" Text="Relatório de Tratamentos Realizados por Período" runat="server" meta:resourcekey="lt00Resource1"/></label></h2>                  
        ...
        <div class="col-lg-12">
            ...
            <asp:GridView ID="gvRelatorio" runat="server" AllowPaging="True" CssClass="table table-bordered table-striped" 
                    DataKeyNames="Código" AutoGenerateColumns="False" meta:resourcekey="gvRelatorioResource1">            
                <Columns>                    
                    <asp:TemplateField HeaderText="Código do Tratamento" meta:resourcekey="TemplateFieldResource1">                    
                        <ItemTemplate>
                            <%#Eval("Código") %>
                        </ItemTemplate>                    
                    </asp:TemplateField>   
                    ...
                    <asp:TemplateField HeaderText="Data Inicial" meta:resourcekey="TemplateFieldResource3">                    
                        <ItemTemplate>
                            <%#Eval("Data_Inicial") %>
                        </ItemTemplate>                    
                    </asp:TemplateField>   
                    <asp:TemplateField HeaderText="Data Final" meta:resourcekey="TemplateFieldResource4">                    
                        <ItemTemplate>
                            <%#Eval("Data_Final") %>
                        </ItemTemplate>                    
                    </asp:TemplateField>   
